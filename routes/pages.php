...
Route::get('aboutz', 'HomeController@index');
...
// Route::get('submission', 'HomeController@index');
// Route::get('vote-success', 'HomeController@index');
// Route::get('pointhistory', 'HomeController@index');

Route::get('tentang', 'HomeController@index');
Route::get('jadwallomba', 'HomeController@index');
