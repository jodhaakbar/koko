...
use App\Models\Mlidm;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class MlidmController extends Controller {
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('mlidm.public.view',$data);			
			}			
		} 
		else {
			...
			return view('mlidm.public.index',$data);	
		}
