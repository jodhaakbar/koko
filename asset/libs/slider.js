...
$.fn.basicSlider = function(opt) {
    ...
    var bindEvents = function() {
        ...
        selector.mainContainer.find(selector.satu).click(function() { _this.moveSatu() });
         selector.mainContainer.find(selector.dua).click(function() { _this.moveDua() });
          selector.mainContainer.find(selector.tiga).click(function() { _this.moveTiga() });
           selector.mainContainer.find(selector.empat).click(function() { _this.moveEmpat() });
    },
    ...
    // move crousel
    this.moveSatu = function() {
        selector.mainContainer.find(selector.ul).animate({ 'left': -((0)*options.crouselWidth)+'px' }, 800, function() {});
    };

    // move crousel
    this.moveDua = function() {
        selector.mainContainer.find(selector.ul).animate({ 'left': -((1)*options.crouselWidth)+'px' }, 800, function() {});
    };

    // move crousel
    this.moveTiga = function() {
        selector.mainContainer.find(selector.ul).animate({ 'left': -((2)*options.crouselWidth)+'px' }, 800, function() {});
    };

     // move crousel
    this.moveEmpat = function() {
        selector.mainContainer.find(selector.ul).animate({ 'left': -((3)*options.crouselWidth)+'px' }, 800, function() {});
    };
