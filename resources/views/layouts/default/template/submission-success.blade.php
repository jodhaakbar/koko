...
<html>
<head>
    <title>VOTE SUCCESS- NESCAF&Eacute; Kickstart</title>
     <meta charset="UTF-8">
            ...
            <div class="col-md-8 col-xs-12 col-md-offset-2">
              <form method="POST" action="">
                <div class="body-submission-white">
                    <h4>Terima kasih atas dukunganmu! </h4>
                    <p class="text-center">
                        Nantikan pengumuman pemenang finalist Kickstart favoritmu dan kumpulkan poin sebanyak-banyaknya dengan beli produk NESCAF&Eacute; di Indomaret dan Alfamart. Ayo kumpulkan poinnya dan menangkan hadiah menarik!

                    </p>

                    <div style="margin:20px 0 10px 0;" class="text-center">
                      <a href="{{ URL::to('/') }}">
                        <img src="asset/images/btn-kumpulkan.png">
                      </a>
                    </div>
                    <div class="text-center">
                        <h4 style="margin:20px 0 10px 0;">SHARE</h4>
                        <a href="http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fkickstart.nescafe.co.id%2F&title={{ \Auth::user()->sso_firstname }}%20telah%20berhasil%20vote%20finalis%20kreatif%20di%20nescafekickstart.com%2C%20yuk%20ikutan!&summary={{ \Auth::user()->sso_firstname }}%20telah%20berhasil%20mengunggah%20ide%20kreatif%20di%20kickstart.nescafe.co.id%2C%20yuk%20ikutan!&source=https%3A%2F%2Fkickstart.nescafe.co.id%2F" style="margin:0 10px;">
                          <img src="asset/images/icon-linkedin.png">
                        </a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fkickstart.nescafe.co.id%2F&quote={{ \Auth::user()->sso_firstname }}%20telah%20berhasil%20vote%20finalis%20kreatif%20di%20nescafekickstart.com%2C%20yuk%20ikutan!" style="margin:0 10px;">
                          <img src="asset/images/icon-facebook.png">
                        </a>
                        <a href="https://twitter.com/intent/tweet?source=https%3A%2F%2Fkickstart.nescafe.co.id%2F&text={{ \Auth::user()->sso_firstname }}%20telah%20berhasil%20vote%20finalis%20kreatif%20di%20nescafekickstart.com%2C%20yuk%20ikutan!:%20https%3A%2F%2Fkickstart.nescafe.co.id%2F" style="margin:0 10px;">
