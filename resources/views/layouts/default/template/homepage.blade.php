...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="asset/bootstrap-less/css/bootstrap-theme.min.css">
...
<body>
	      ...
	      <div class="">
	        ...
	        <div class="collapse navbar-collapse navbar-custom" id="bs-navbar-collapse-1">
	          <ul class="nav navbar-nav">
	            <li><a href="index.html" class="active home">BERANDA</a></li>
	            <li><a href="about.html">TENTANG</a></li>
	            <li><a href="schedule.html">JADWAL LOMBA</a></li>
	    			...
	    			<div class="contact">
	    				<div style="width: 30px;float: left;padding: 10px 0 0 0">
	    					<a href="https://www.sahabatnestle.co.id/contactus" title="Kontak Kami">
	    						<img style="width:25px" src="asset/images/web/icon-mail.png">
	    					</a>
	    				</div>
	    				<div style="width: 70px;float: left;padding: 15px 0 0 0">
	    					<a href="https://www.sahabatnestle.co.id/contactus" title="Kontak Kami">
	...
	<div class="floating-notice visible-xs text-center">
    	<a href="register.html"><h4><b><u>Daftar Lomba</u></b></h4></a>
  	</div>
