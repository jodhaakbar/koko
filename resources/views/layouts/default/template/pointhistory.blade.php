...
<body>
  ...
  <!--
          ...
          <div class="col-md-9 col-xs-12 col-sm-12">
            <div class="account-setting" id="leaderboard">
              <div class="row">
        <div class="col-md-4 col-md-offset-5">
        <div class="col-md-12 ">
          <ul class="nav leaderboard nav-tabs">
            <li class="active"><a href="#indomaret"><img src="{{ URL::to('/') }}/asset/images/logo-indomaret.png" style="width: 100px"></a></li>
            <li><a href="#alfamart"><img src="{{ URL::to('/') }}/asset/images/logo-alfamart.png" style="width: 100px"></a></li>
          </ul>
        </div>
      </div>
        <div class="col-md-6 col-md-offset-3">
          <div class="tab-content">
            <div id="indomaret" class="tab-pane fade in active">
              <h4 class="points">History Indomaret MyPoin</h4>
              <table class="table table-leaderboard text-left">
                <tr>
                      <td>Registrasi Point</td>
                      <td class="points"> DALAM PROSES</td>
                    </tr>
                    <tr>
                      <td>Voting Point</td>
                      <td class="points">{{{ $voting_idm or 'DALAM PROSES' }}}</td>
                    </tr>
                    <tr>
                      <td>Indomaret MyPoin</td>
                      <td class="points">{{{ $mypoin or 'DALAM PROSES' }}}</td>
                    </tr>
                    <tr>
                      <th>Total</th>
                      <td class="points">{{{ $total_idm or 'DALAM PROSES' }}}</td>
                    </tr>
              </table>
            </div>
            <div id="alfamart" class="tab-pane fade">
              <h4 class="points">History Alfamart Ponta</h4>
              <table class="table table-leaderboard">
                <tr>
                    ...
                    <tr>
                      <td>Voting Point</td>
                      <td class="points">{{{ $voting_sat or 'DALAM PROSES' }}}</td>
                    </tr>
                    <tr>
                      <td>Alfamart Ponta</td>
                      <td class="points">{{{ $ponta or 'DALAM PROSES' }}}</td>
                    </tr>
                    <tr>
                      <th>Total</th>
                      <td class="points">{{{ $total_sat or 'DALAM PROSES' }}}</td>
                    </tr>
              </table>
            </div>
          </div>
