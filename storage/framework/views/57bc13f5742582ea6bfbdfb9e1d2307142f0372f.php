	        ...
	        <div class="collapse navbar-collapse navbar-custom" id="bs-navbar-collapse-1">
	          <ul class="nav navbar-nav">
							<ul class="nav navbar-nav">
							 ...
							 <li><a href="<?php echo e(URL::to('/')); ?>/daftar/" class="active" >DAFTAR</a></li>
	    ...
	    <div class="body-content" id="register">
	    		...
	    		<div class="col-xs-12 col-md-8 col-md-offset-2">
						...
						<?php endif; ?>
							...
							<?php echo Form::open(array('id' => 'userdetail', 'url'=>'mpeserta', 'class'=>'form-horizontal validated','files' => true )); ?>
	    			...
	    			<div class="text-center">
	    				<button type="submit" style="background: none;border:none;">
							<img src="<?php echo e(URL::to('/')); ?>/asset/images/web/icon-submit.png" width="200px"/>
						</button>
	    			</div>
	    		</div>
	    		<div class="clearfix"></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table">
        	...
        	<tbody>
						<?php $pos = 1 ?>
				<?php if(isset($data_peserta)): ?>

					<?php $__currentLoopData = $data_peserta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							<td><?php echo e($pos++); ?></td>
							<td><?php echo e($node->nama_anak); ?></td>
							<td><?php echo e($node->jenis_kelamin); ?></td>
							<td><?php echo e($node->tanggal_lahir); ?></td>
						</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				<?php else: ?>
				<tr>
