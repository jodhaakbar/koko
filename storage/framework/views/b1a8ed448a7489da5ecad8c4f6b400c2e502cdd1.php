...
<div class="page-content row">
 ...
 <?php echo Form::open(array('url'=>'sximo/module/savetable/'.$module_name, 'class'=>'form-horizontal','id'=>'fTable')); ?>


		<?php echo $__env->make('sximo.module.tab',array('active'=>'table','type'=>$type), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			...
			<?php usort($tables, "SiteHelpers::_sort"); ?>
			  ...
			  <tr >
				...
				<span class=" xlick " title="Lookup Display" 
					onclick="SximoModal('<?php echo e(URL::to('sximo/module/conn/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias'])); ?>' ,' Connect Field : <?php echo e($rows['field']); ?> ' )"
					>
				...
				<select class="select-alt" name="format_as[<?php echo $id;?>]" style="width:100px;">
					...
					<option value="<?php echo e($key); ?>" <?php if(isset($rows['format_as']) && $rows['format_as'] ==$key) echo 'selected';?> > <?php echo e($val); ?> </option>
