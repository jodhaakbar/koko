        ...
        <section >
                ...
                <div class="row m-l-none m-r-none m-t  white-bg shortcut " >
                    <div class="col-sm-3  p-sm ribon-grey3">
                        ...
                        <a href="#"  class="clear">
                            <span class="h3 block m-t-xs"><strong> <?php echo e($total_submission->total); ?>     </strong>
                    ...
                    <div class="col-sm-3 p-sm ribon-grey2">
                        ...
                        <a href="javascript:void(0)" class="clear " onclick="$('.unziped').toggle()">
                            <span class="h3 block m-t-xs"><strong> <?php echo e($total_user->total); ?>  </strong>
                    ...
                    <div class="col-sm-3   p-sm ribon-grey3">
                        ...
                        <a >
                            <span class="h3 block m-t-xs"><strong> <?php echo e($total_idm->total); ?>  </strong>
                    ...
                    <div class="col-sm-3   p-sm ribon-grey3">
                        ...
                        <a >
                            <span class="h3 block m-t-xs"><strong>  <?php echo e($total_sat->total); ?> </strong>
...
<div class="row">
<div class="sbox-title"> <h3>PERINGKAT VOTING  [ <?php echo e($current_date); ?> ] </h3></div>
...
<script type="text/javascript" src="<?php echo e(asset('sximo5/js/plugins/jquery.sparkline.min.js')); ?>"></script>
    <script>
