...
<html>
<head>
	<title>TENTANG - Koko Krunch</title>
  <meta charset="UTF-8">
	        ...
	        <div class="collapse navbar-collapse navbar-custom" id="bs-navbar-collapse-1">
	          <ul class="nav navbar-nav">
							<ul class="nav navbar-nav">
							 ...
							 <li><a href="<?php echo e(URL::to('/')); ?>/tentang/" class="active">TENTANG</a></li>
	...
	<div class="container-fluid-full">
	    <div class="body-content" id="about">
	    		<div class="col-xs-12 col-md-8 col-md-offset-2">
	    			<ul>
	    				<li>Nestl&eacute; adalah Perusahaan Nutrisi, Kesehatan dan Kebugaran terkemuka. Produk mereka meningkatkan kehidupan dengan solusi gizi dan kesehatan berbasis sains untuk semua tahap kehidupan, membantu konsumen merawat diri mereka dan keluarga mereka.</li>
	    				<li>Koko Krunch adalah salah satu produk sereal dari Nestl&eacute;. Ini adalah sereal lezat yang dibuat dengan gandum termasuk tujuh vitamin dan mineral penting, ditambah dengan rasa cokelat kaya yang disukai anak-anak. Nestl&eacute; melalui Koko Krunch ingin melakukan acara tahunan "Koko Olimpiade" yang mencakup skala nasional.</li>
	    				<li>Tujuan dari acara ini adalah untuk meningkatkan kreatifitas anak melalui lomba menggambar dan mewarnai.</li>
	    				<li>Acara  ini akan diselenggarakan di 45 area di seluruh Indonesia dan puncak acara di Jakarta.</li>
	    				<li>Target peserta adalah  anak sekolah dasar kelas 1-6 sebanyak 1000 anak disetiap area dengan jumlah target 45.000 peserta.</li>
	    				<li>Akan ada 2 kategori di perlombaan ini :<br />1 - 3 SD: mewarnai<br />4 - 6 SD: menggambar</li>
	    			</ul>
	    		</div>
	    	<div class="clearfix"></div>
